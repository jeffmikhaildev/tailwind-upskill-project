		...
		<div className="flex justify-center items-center min-h-screen bg-neutral-900">
			<div className="bg-neutral-800 p-8 rounded-lg shadow-lg w-full max-w-md border border-neutral-700">
				...
				<form className="space-y-4">
					...
					<button className="w-full py-2 px-4 bg-gradient-to-r from-orange-500 to-orange-800 rounded-md text-white font-semibold transition-all duration-300 hover:scale-105">Sign In</button>
				</form>
